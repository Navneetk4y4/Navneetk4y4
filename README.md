...
```diff
+ CompTIA Pentest+ (Sep 2025)     - Advanced Penetration Testing
+ CompTIA Security+ (June 2025)   - Cybersecurity Fundamentals  
+ Digital Forensic Investigator   - QuickHeal (Jan 2025)
+ CompTIA Network+ (Sep 2024)     - Network Security Architecture
